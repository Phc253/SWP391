...
namespace SWP391.Migrations
{
    ...
    [Migration("20260715155635_AddUserCredits")]
    partial class AddUserCredits
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SWP391.Entities.PasswordResetPin", b =>
                {
                    b.Property<long>("PasswordResetPinId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("PasswordResetPinId"));
                    ...
                    b.HasKey("PasswordResetPinId");

                    b.HasIndex(new[] { "PinHash" }, "IX_PasswordResetPins_PinHash")
                        .IsUnique();

                    b.HasIndex(new[] { "UserId", "UsedAt" }, "IX_PasswordResetPins_User_UsedAt");
            ...
            modelBuilder.Entity("SWP391.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("LastCreditResetTime")
                        .HasColumnType("datetime2");
